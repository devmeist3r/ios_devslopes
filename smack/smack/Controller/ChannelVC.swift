...
class ChannelVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var ivImage: CircleImage!
    ...
    func setupUserInfo() {
        if AuthService.instance.isLoggedIn {
            ...
            ivImage.image = UIImage(named: UserDataService.instance.avatarName)
            ivImage.backgroundColor = UserDataService.instance.returnUIColor(components: UserDataService.instance.avatarColor)
        } else {
            btnLogin.setTitle("Login", for: .normal)
            ivImage.image = UIImage(named: "menuProfileIcon")
            ivImage.backgroundColor = UIColor.clear
            tableView.reloadData()
        }
    }
